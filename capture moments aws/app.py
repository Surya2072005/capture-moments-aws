...
app.config['MAIL_USERNAME'] = 'seerasuryaprasad21@gmail.com'       # Replace with your email
app.config['MAIL_PASSWORD'] = 'surya@12345'            # Replace with app password

mail = Mail(app)

# Step 3: Dummy data for photographers (simulating database)
photographers = [
    {"id": "p1", "name": "raju", "skills": ["Wedding", "Portrait"], "image": "raju.jpg","location":"Hyderabad"},
    {"id": "p2", "name": "ram", "skills": ["Fashion", "Event"], "image": "ram.jpg","location":"Mumbai"},
    {"id": "p3", "name": "sana", "skills": ["All Events", "Event"], "image": "sana.jpg","location":"Benguluru"}
]
